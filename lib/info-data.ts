...
export const infoSections: InfoSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Conf #: 9086280313578 · Amex Trip #ZO-AX1037-78961", emphasis: true },
      { text: "Calle de Mejía Lequerica, 8, Madrid", mapsQuery: "URSO Hotel Spa Madrid" },
      { text: "Restored 1920s palace · Full spa · Early check-in friendly" },
      { text: "—" },
      { text: "Hotel Colón Gran Meliá — 3 nights (May 17-19)", emphasis: true },
      { text: "Conf #: 9086785389099 · Amex Trip #ZO-AX1040-93233", emphasis: true },
      ...
      { text: "Rooftop plunge pool · Clarins spa" },
      { text: "—" },
      { text: "Gran Hotel Inglés — 2 nights (May 20-21)", emphasis: true },
      { text: "Conf #: 9100117664541 · Amex Trip #ZO-AX1040-93841", emphasis: true },
  ...
  },
  {
    ...
    emoji: "🗣️",
    title: "Language",
    summary: "Castilian Spanish essentials — Ang is our translator",
    items: [
      { text: "Ang speaks Spanish — she's our go-to for anything beyond these basics", emphasis: true },
      { text: "—" },
      { text: "La cuenta, por favor — The check, please", emphasis: true },
      { text: "Una mesa para cuatro — A table for four" },
      { text: "Agua del grifo, por favor — Tap water (free)" },
      { text: "¡Salud! — Cheers!" },
      { text: "¿Dónde está...? — Where is...?" },
      { text: "Un vino tinto / blanco — A red / white wine" },
      { text: "Ponme una caña — A small draft beer (sounds local)" },
      { text: "Vale — OK / sure / got it (you'll hear this constantly)" },
      { text: "Perdona — Excuse me (casual, for getting attention)" },
      { text: "Quédese con el cambio — Keep the change" },
      { text: "—" },
      { text: "Castilian Spanish notes:", emphasis: true },
      { text: "Waiter = 'camarero/a' (not mesero like in Latin America)" },
      { text: "'C' and 'Z' are pronounced 'th' — gracias sounds like 'grathias'" },
      { text: "Vale (bah-leh) is used like Americans use 'OK' — constantly" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Power adapter — Spain uses Type C/F (European round prongs)", emphasis: true },
  ...
  },
  {
    ...
    summary: "SIM, apps, time zone",
    items: [
      { text: "Spain is 6 hours ahead of US Eastern Time", emphasis: true },
      { text: "Check your carrier's international plan — T-Mobile has free roaming, AT&T/Verizon charge ~$10/day" },
      { text: "Alternative: buy an eSIM (Airalo or Holafly) for ~$15-25/week" },
      { text: "Download offline maps in Google Maps or Apple Maps before you go" },
      { text: "—" },
      { text: "Useful apps:", emphasis: true },
      { text: "Uber / Cabify / FreeNow — ride-hailing (all work in Madrid & Seville)" },
      { text: "Renfe — train tickets and schedules" },
      { text: "Google Translate — camera mode for menus" },
      { text: "WhatsApp — used more than SMS in Spain" },
    ],
  },
  {
    id: "pharmacies",
